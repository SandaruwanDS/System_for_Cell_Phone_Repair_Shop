                    ...
                    <div class="col-sm-12">
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{route('add_opening_stock')}}" method="post">
                                    @csrf
                                    <div class="row ">
                                                ...
                                                {{-- <label for="job_no"> Job No:
                                                    <div class="input-group">
                                                        <input type="text" class="form-control  form-control-lg"
                                                            ...
                                                            placeholder="Enter Job No" required />
                                        ...
                                        <table class="table table-bordered">
                                            <thead class="thead-light">
                                                <tr>
                                                    ...
                                                    <th style="width:15%; text-align: center;">Net Value</th>
                                        ...
                                        <div class="row mt-2">
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <input class="form-control " type="text"
                                                        id="brand" name="brand" readonly required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <input class="form-control " type="text"
                                                        id="device_model" name="device_model" readonly required>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                    <label for="receipt_date">Reported On:</label>
                                                    <input class="form-control datetimepicker" type="date"
                                                        id="receipt_date" name="receipt_date" readonly required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col">
                                                    ...
                                                    <input class="form-control datetimepicker" type="date"
                                                        id="completed_on" name="completed_on"  required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col">
                                                    ...
                                                    <input class="form-control " type="text"
                                                        id="imei_number" name="imei_number" readonly required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col">
                                                    ...
                                                    <input class="form-control " type="text"
                                                        id="status" name="status" readonly required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#item_category').on('change', function () {
                ...
                $.ajax({
                            url: "{{ route('show_select_category_item_open_stock_ajax') }}",
                            method: 'GET',
                            data: {
                                "_token": "{{ csrf_token() }}",
                                category: category
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#item_code').on('change', function () {
                let Item_code = $('#item_code').val();
                $.ajax({
                            url: "{{ route('show_select_item_description_open_stock_ajax') }}",
                            method: 'GET',
                            data: {
                                "_token":"{{ csrf_token() }}",
                                Item_code:Item_code
