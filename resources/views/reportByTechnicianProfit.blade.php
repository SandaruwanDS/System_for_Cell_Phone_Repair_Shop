@if($recipts->count() > 0)
<h2>Technician Profit Report</h2>
@else
...
<title>Technician Profit Report</title>
<style>
    table{
    ...
    <div class="d-flex justify-content-center profile-container">
        ...
        <div class='col-md-6 text-center' ><br/>
            <div styel="background-color: yellow;">
                ...
                <h2 style="text-align:center;"><b>Technician Profit Report</b></h2><hr/>
            </div>
        ...
        <table class="styled-table" class="display" id="t_item_movements" style="background-color: transparent; border:1px solid rgb(7, 7, 7); margin-top:15px;">
            ...
            @foreach ( $recipts as $key=>$recipts)
                <tr>
                    ...
                    <td>{{$recipts->Net_value }}</td>
                    {{-- <td>{{$recipts->Status }}</td> --}}
                    <td>{{$recipts->Net_value - $recipts->purchasePrice }}</td>
                </tr>
            @endforeach
            </tbody>
            <tfoot>
                <tr>
                    <td colspan="2"><b>Total Number Of Items :
                        @if($recipts!=null)
                        {{$jobCount}}
                        @endif
                    </b></td>
