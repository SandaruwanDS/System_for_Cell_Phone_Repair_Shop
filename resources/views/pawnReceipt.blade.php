...
<body>
                                                ...
                                                <tr>
                                                    <td>
                                                        <select class="select form-control"
                                                            {{-- name="inputs[0][category]" --}} id="category"
                                                            aria-hidden="true">
                                                            <option value="">Please Select</option>
                                                    ...
                                                    <td>
                                                        <select class="select form-control "
                                                            {{-- name="inputs[0][articles]" --}} id="articles"
                                                            aria-hidden="true">
                                                            <option value="">Please Select</option>
                                                    ...
                                                    <td>
                                                        <select class="select form-control "
                                                            {{-- name="inputs[0][condition]" --}} id="condition"
                                                            aria-hidden="true">
                                                            <option value="">Please Select</option>
                                                    ...
                                                    <td>
                                                        <select class="select form-control "
                                                            {{-- name="inputs[0][karatage]" --}} id="karatage"
                                                            aria-hidden="true">
                                                            <option value="">Please Select</option>
                                                            ...
                                                            {{-- <option value="{{ $karatageData->descrption}}">{{ $karatageData->descrption}}
                                                            </option> --}}
                                                            @endforeach
                                                        </select>
                                                    </td>
                                                    <td>
                                                        <input class="form-control" type="text" placeholder="Weight"
                                                            id="weight" {{-- name="inputs[0][weight]" --}}>
                                                    </td>
                                                    <td>
                                                        <input class="form-control" type="text"
    ...
    <div class="modal fade" id="paymentHistoryModel" tabindex="-1" role="dialog" aria-labelledby="paymentHistoryLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <script type="text/javascript">
        ...
        $(".dynamic-ar,#dynamic-ar").click(function () {
            ...
            if (receipt_type == "" || receipt_no == "" || receipt_date == "" || category == "" || articles ==
